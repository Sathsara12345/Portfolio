          ...
          >
            ...
            >
              <div className="relative">
                ...
                <motion.img 
                  src={`${import.meta.env.BASE_URL}assets/img/hi_there___waving_animated_3D_web_developer-removebg-preview.png`} 
                  alt="Profile" 
            ...
            >
              <div className="relative">
                ...
                <motion.img 
                  src={`${import.meta.env.BASE_URL}assets/img/Graduated_from_cardiff_metropolitan_university.png`} 
                  alt="Education" 
                  className="relative z-10 max-w-full"
                  initial={{ scale: 0.9, rotate: 5 }}
                  animate={{ scale: 1, rotate: 0 }}
            ...
            >
              <div className="relative">
                ...
                <motion.img 
                  src={`${import.meta.env.BASE_URL}assets/img/Working_in_front_of_laptop_3D_animated_boy-removebg-preview.png`} 
                  alt="Working" 
                  className="relative z-10 max-w-full"
                  initial={{ scale: 0.9 }}
                  animate={{ scale: 1 }}
